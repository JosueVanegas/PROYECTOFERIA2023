...
namespace CapaVista.FormsHerramientas
{
    public partial class FormGenerarCodigoBarra : MaterialForm
    {
        ...
        public static Bitmap convertirTextoImagen(string texto, int ancho, Color color)
        {
            ...
            int Width = 2;
            int Height = 0;
            System.Drawing.Font objFont = new System.Drawing.Font("Arial", 12, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Pixel);
            ...
            objGraphics.DrawString(texto, objFont, new SolidBrush(Color.Black), new RectangleF(10, (objBitmap.Height / 2) - (objBitmap.Height - 10), objBitmap.Width, objBitmap.Height), drawFormat);
            objGraphics.Flush();
            return objBitmap;
        }
    }
